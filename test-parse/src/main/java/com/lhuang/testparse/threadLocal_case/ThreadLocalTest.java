package com.lhuang.testparse.threadLocal_case;
...
public class ThreadLocalTest {
    ...
    static class ControlThread implements Runnable {
        ...
        public void run() {
            ...
            //通过线程池创建线程，则复用线程时不会通过new方法创建，则复用的子线程不能够进行inheritableThreadLocals值的复制
            // 故复用的子线程中的inheritableThreadLocals为第一个提交任务的外部线程（该复用线程的第一次提交）；
            //使用线程池异步处理任务
